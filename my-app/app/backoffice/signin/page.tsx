      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center p-3 sm:p-5">
        <div className="w-full max-w-[360px] rounded-[22px] border border-slate-700/70 bg-slate-900/85 p-5 sm:p-6 shadow-[8px_8px_0_0_rgba(255,255,255,0.08)] backdrop-blur-xl">
          <div className="mb-5 flex flex-col gap-1 text-left">
            <p className="text-[25px] font-bold text-blue-200 text-center">Sign In</p>
            <span className="text-xs sm:text-sm font-medium text-slate-400 text-center">sign in to continue</span>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              className="mt-2 w-full rounded-2xl border border-slate-700 bg-slate-800 px-3 py-2 text-sm font-semibold text-slate-100 transition hover:bg-blue-900/50 hover:border-blue-500/50"
              onClick={() => router.push('/backoffice/signup')}
            >
              Go to Sign Up
            </button>
          </div>
